...
namespace Solo_Project {
    ...
    public partial class UserDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class productDataTable : global::System.Data.TypedTableBase<productRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productRow AddproductRow(string BookName, string Author, int Stock, decimal Price) {
...
namespace Solo_Project.UserDatabaseDataSetTableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[product] ([BookName], [Author], [Stock], [Price]) VALUES (@Boo" +
                "kName, @Author, @Stock, @Price);\r\nSELECT ProductID, BookName, Author, Stock, Pri" +
                "ce FROM product WHERE (ProductID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[product] SET [BookName] = @BookName, [Author] = @Author, [Stock] = @Stock, [Price] = @Price WHERE (([ProductID] = @Original_ProductID) AND ([BookName] = @Original_BookName) AND ([Author] = @Original_Author) AND ([Stock] = @Original_Stock) AND ([Price] = @Original_Price));
SELECT ProductID, BookName, Author, Stock, Price FROM product WHERE (ProductID = @ProductID)";
        ...
        public virtual int Fill(UserDatabaseDataSet.productDataTable dataTable) {
        ...
        public virtual UserDatabaseDataSet.productDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDatabaseDataSet.productDataTable dataTable = new UserDatabaseDataSet.productDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDatabaseDataSet.productDataTable dataTable) {
        ...
        public virtual int Insert(string BookName, string Author, int Stock, decimal Price) {
            if ((BookName == null)) {
        ...
        public virtual int Update(string BookName, string Author, int Stock, decimal Price, int Original_ProductID, string Original_BookName, string Original_Author, int Original_Stock, decimal Original_Price, int ProductID) {
            if ((BookName == null)) {
                throw new global::System.ArgumentNullException("BookName");
            }
            else {
        ...
        public virtual int Update(string BookName, string Author, int Stock, decimal Price, int Original_ProductID, string Original_BookName, string Original_Author, int Original_Stock, decimal Original_Price) {
            return this.Update(BookName, Author, Stock, Price, Original_ProductID, Original_BookName, Original_Author, Original_Stock, Original_Price, Original_ProductID);
        }
    }
